(function (global, factory) {
  ...
  function defineVisitSet() {
    ...
    this.data.sets.visit_col = this.data.sets.visits.filter(function (visit) {
      return _this.settings.visit_exclusion_regex ? !_this.settings.visit_exclusion_regex.test(visit) : true;
    }).sort(function (a, b) {
    ...
    this.data.sets.unscheduledVisits = d3.set(this.data.sets.visits.filter(function (visit) {
      ...
      return yesPlease;
    })).values().sort(); //Update ordinal chart settings.
      ...
      var _loop = function _loop() {
        ...
        try {
          var _loop2 = function _loop2() {
            ...
            datum["".concat(visit, "-date")] = visit_datum ? visit_datum[_this.settings.visit_date_col] : '';
            datum["".concat(visit, "-status")] = visit_datum ? visit_datum[_this.settings.visit_status_col] : '';
            datum["".concat(visit, "-color")] = visit_datum ? visit_datum[_this.settings.visit_status_color_col] : '';
  ...
  function click(element, d) {
    ...
    console.log(this.highlight.points.size()); //Append a reference line of the median study day of the selected visit.
