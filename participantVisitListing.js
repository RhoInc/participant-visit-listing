(function (global, factory) {
  ...
  function controls() {
    ...
    this.controls = webcharts.createControls(this.containers.controls.node(), this.settings.controlsSynced);
  }
  ...
  function listing() {
    //Define listing.
    this.listing = webcharts.createTable(this.containers.listing.node(), this.settings.listingSynced, this.controls);
  ...
  function onLayout$1() {
    ...
    if (this.pvl.settings.active_tab !== 'Visit Chart' && this.pvl.settings.chart_layout === 'tabbed') this.pvl.containers.ordinalChart.classed('pvl-hidden', true);
    scrolling.call(this);
  }
  ...
  function ordinalChart() {
    //Define listing.
    this.ordinalChart = webcharts.createChart(this.containers.ordinalChart.node(), this.settings.ordinalChartSynced, this.controls);
  ...
  function onLayout$2() {
    ...
    if (this.pvl.settings.active_tab !== 'Charts' && this.pvl.settings.chart_layout === 'side-by-side') this.pvl.containers.charts.classed('pvl-hidden', true);
    if (this.pvl.settings.active_tab !== 'Study Day Chart' && this.pvl.settings.chart_layout === 'tabbed') this.pvl.containers.linearChart.classed('pvl-hidden', true);
    scrolling.call(this);
  }
