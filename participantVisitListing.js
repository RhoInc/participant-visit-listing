(function (global, factory) {
  ...
  function addVisitExpectationLegend() {
    this.visitExpectationLegend = {
      g: this.pvl.containers.tabContainer.insert('div', ':first-child').style({
        position: 'absolute',
        top: 0,
        left: 0,
      ...
      }).append('g').classed('pvl-mark-legend', true) //.attr({
      //    transform: `translate(-60,${-this.pvl.settings.chart_margin.top})`,
      //})

    }; //past visits

    this.visitExpectationLegend.past = this.visitExpectationLegend.g.append('g').classed('pvl-mark-legend__item pvl-mark-legend__item--past', true).attr({
      transform: "translate(0,".concat(4, ")")
    });
    this.visitExpectationLegend.past.append('rect').attr({
      x: 0,
      width: 100,
      y: 0,
    ...
    this.visitExpectationLegend.future = this.visitExpectationLegend.g.append('g').classed('pvl-mark-legend__item pvl-mark-legend__item--future', true).attr({
      transform: "translate(0,".concat(4 * 2 + this.config.y.range_band, ")")
    });
    this.visitExpectationLegend.future.append('rect').attr({
      x: 0,
      width: 100,
      y: 0,
      height: this.config.y.range_band,
