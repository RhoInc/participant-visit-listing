(function (global, factory) {
  ...
  function layout() {
    ...
    if (this.settings.chart_layout === 'tabbed') {
      this.containers.ordinalChart = this.containers.lowerRow.append('div').classed('pvl-chart pvl-chart--ordinal pvl-chart--full', true);
      this.containers.linearChart = this.containers.lowerRow.append('div').classed('pvl-chart pvl-chart--linear pvl-chart--full', true);
    } else {
      this.containers.charts = this.containers.lowerRow.append('div').classed('pvl-charts', true);
      this.containers.ordinalChart = this.containers.charts.append('div').classed('pvl-chart pvl-chart--ordinal pvl-chart--side-by-side', true);
      this.containers.linearChart = this.containers.charts.append('div').classed('pvl-chart pvl-chart--linear pvl-chart--side-by-side', true);
    }
  ...
  function addTooltipsToXAxisTicks() {
    ...
    this.wrap.selectAll('.x.axis .tick').append('title').text(function (d) {
  ...
  function addVisitExpectationLegend() {
    ...
    this.containers.visitExpectationLegend.past.text.html(this.containers.visitExpectationLegend.past.text.html().replace('</tspan><tspan', '</tspan>/<tspan')); //future visits
    ...
    this.containers.visitExpectationLegend.future.text.html(this.containers.visitExpectationLegend.future.text.html().replace('</tspan><tspan', '</tspan>/<tspan'));
  }
