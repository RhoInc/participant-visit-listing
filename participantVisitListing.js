(function (global, factory) {
  ...
  function rendererSettings() {
      ...
      return _ref = {
          ...
          chart_layout: 'side-by-side' }, defineProperty(_ref, 'chart_layout', 'tabbe'), defineProperty(_ref, 'date_format', '%Y-%m-%d'), defineProperty(_ref, 'chart_margin', {
          top: 100,
          bottom: 100
      }), _ref;
  }
  ...
  function addLegend() {
      ...
      this.containers.legendItems.each(function (d) {
          ...
          legendItem.append('span').classed('pvl-legend-item-info-icon', true).html('&#9432').style({
              ...
              return !context.settings.visit_expectation_regex.test(d[1]) ? d[3] : d[3] + '\n' + d[1] + ' visits are identified in the charts as cells or circles with medial white circles.';
          });
      });
      update.call(this);
  }
