...
export default function onLayout() {
    ...
    if (this.pvl.settings.active_tab !== 'Charts' && this.pvl.settings.chart_layout === 'side-by-side')
        this.pvl.containers.charts.classed('pvl-hidden', true);
    if (this.pvl.settings.active_tab !== 'Study Day Chart' && this.pvl.settings.chart_layout === 'tabbed')
