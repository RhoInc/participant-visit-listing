...
const ordinalChartSettings = require('../src/configuration/ordinalChartSettings.js').default;
const linearChartSettings = require('../src/configuration/linearChartSettings.js').default;
const markdown = [];
...
markdown.push(
    `The objects below contain Webcharts settings for each display as of version ${
        schema.version
    } of the Participant Visit Listing.`
);

[listingSettings, ordinalChartSettings, linearChartSettings].forEach(settingsFx => {
...
fs.writeFile('./scripts/configuration-wiki.md', markdown.join('\n'), err => {
