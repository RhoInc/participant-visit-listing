(function(global, factory) {
    ...
    function attachMarks() {
        ...
        this.blanks = this.svg.selectAll('.point').filter(function(d) {
            return d.mark.id === 'mark2';
        });
    ...
    function clearHighlight() {
        if (this.highlight) {
            ...
            this.highlight.container.remove(); //De-class highlighted circles and reset their opacity.
    ...
    function click(element, d) {
        ...
        clearHighlight.call(this); //Select all points.
