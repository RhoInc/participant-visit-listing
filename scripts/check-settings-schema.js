...
// differences
const missingExpectedSettings = actualSettings.filter(
    setting => expectedSettings.indexOf(setting) < 0
);
...
const missingActualSettings = expectedSettings.filter(
    setting => actualSettings.indexOf(setting) < 0
);
